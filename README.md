...
A public collection of **reusable rules and guidelines for AI coding agents**.

This repository contains opinionated, battle-tested rules that help coding agents:

* produce consistent, high-quality code
* follow project conventions
* avoid common mistakes
* behave predictably across tools and models

## What this repo is

* A **shared source of truth** for agent rules
